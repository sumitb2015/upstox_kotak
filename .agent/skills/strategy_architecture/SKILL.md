---
name: Strategy Architecture Guidelines
description: Architectural standards and patterns for trading strategies (Core/Live separation, Expiry selection, etc.).
---
